...
Our main contributions are to provide a new visualization of the memory access behavior
distribution by thread and by structure. Such visualization allows the
developer to easily understand why performance issues occurs.
...
improve the memory access behavior of some applications.
