...
memories, as the access time to data depends on the location of the data in
...
not benefit from them. Moreover, automatic mapping tools need time to detect the
best mapping loosing optimization opportunities. A
deeper understanding of the memory behavior can help defining the best mapping
...
Our main contributions are to provide a simple yet precise analysis of the behavior, allowing the
user to easily reach a deep understanding of the memory usage.
...
improve the memory access behavior. Finally, we compare the impact of our
proposition to automated tools.
%
\end{abstract}
