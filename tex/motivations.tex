...
\begin{figure}[htb]
    ...
    \subfigure[Structure A (naive)]{
        \includegraphics[height=.25\textheight] {mat_A_modulo}
        \label{fig:matrix-A-naive}
    }
    \subfigure[Structure B (naive)]{
        \includegraphics[height=.25\textheight] {mat_C_modulo}
...
\begin{figure}[htb]
    ...
    \subfigure[Structure A (bloc)]{
        \includegraphics[height=.25\textheight] {mat_A_bloc}
        \label{fig:matrix-A-bloc}
    }
    \subfigure[Structure B (bloc)]{
        \includegraphics[height=.25\textheight] {mat_C_bloc}
