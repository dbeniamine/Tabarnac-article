...
\DB{ref ??}, none of them provide a user-friendly visualization or automatic suggestions to help the developer improve the memory access behavior of parallel applications.
