...
For each access, we store the type (read or write), the memory page that was accessed, and the thread ID.
...
script which reads these files, retrieves the page / data structure mapping
...
Providing an easily understandable visualization of a memory trace is a challenge. We
...
\begin{figure}[htb]
    ...
    \subfigure[Number of accesses per structure.]{
