...
\begin{figure*}[ht!]
    ...
    \subfigure[Structures size.]{
        \includegraphics[height=.22\textheight]{example_sz}
        \label{fig:example_sz}
    }
    \subfigure[Number of accesses per structures.]{
        \includegraphics[height=.22\textheight]{example_rw}
        \label{fig:example_rw}
    }
    \subfigure[First touch distribution inside a structure.
    ]{
        \includegraphics[height=.22\textheight]{example_ft}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[height=.26\textheight]{example_dist}
