...
\begin{figure}[htb]
    ...
    \subfigure[Structures size.]{
        \includegraphics[width=.64\linewidth]{example_sz}
        \label{fig:example_sz}
    }
    \subfigure[Number of accesses.]{
        \includegraphics[width=.64\linewidth]{example_rw}
...
%    Each point represents the number of access to one page done by one thread.
        ...
        \includegraphics[width=.64\linewidth]{example_dist}
...
%   Each point shows which thread is responsible of the first access on one page.
        ...
        \includegraphics[width=.64\linewidth]{example_ft}
