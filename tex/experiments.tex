...
matrices of size $4096 \times 4096$ doubles, for a memory usage of $12.8$Mib per matrix \tod{4096*4096*8=128 MB?}. \emph{IS} was executed
...
For the plots presenting speedups or execution time, each configuration was executed at least 10 times. Each point represents the arithmetic mean of all runs.
