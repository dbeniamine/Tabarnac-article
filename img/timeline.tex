...
\begin{tikzpicture}
	...
	% legend:
	\draw [] (-1.35,1.5) rectangle +(0.4,0.3) node[right,yshift=-1.4mm] { Normal execution};
	\draw [fill=black] (1.4,1.5) rectangle +(0.4,0.3)node[right,yshift=-1.6mm] { Mapping};
	\draw [fill=gray!30] (3.1,1.5) rectangle +(0.4,0.3) node[right,yshift=-1.4mm] { Training};
	\draw [pattern=crosshatch] (4.8,1.5) rectangle +(0.4,0.3) node[right,yshift=-1.4mm] { Lost opportunities};
